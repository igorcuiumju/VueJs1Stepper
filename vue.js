...
const App = {
  ...
  methods: {
    nextOfFinish() {
      if(this.nextBtn === 'Закончить' && this.activeIndex === this.steps.length - 1) {
        this.prevBtn = 'начать заного'
        this.isRemoved = true
      } else {
        if(this.activeIndex + 1 === this.steps.length - 1) {
